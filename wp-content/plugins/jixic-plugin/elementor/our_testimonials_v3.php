 ...
 * @since 1.0.0
 */
class Our_Testimonials_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'jixic_our_testimonials_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V3', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_testimonials_v3',
			[
				'label' => esc_html__( 'Our Testimonials V3', 'jixic' ),
			]
		);
		$this->add_control(
			'subtitle',
