...
class Our_Testimonials_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'jixic_our_testimonials_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V2', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_testimonials_v2',
			[
				'label' => esc_html__( 'Our Testimonials V2', 'jixic' ),
			]
		);
		$this->add_control(
			'icons',
		...
		$this->add_control(
            'feature_img',
            [
				'label' => esc_html__('Feature image', 'jixic'),
	...
	protected function render() {
        ...
        <section class="testimonial-style2-area">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-6">
                        <div class="testimonial-style2-image-box" data-aos="fade-right" data-aos-easing="linear" data-aos-duration="700">
                                ...
                                <div class="single-testimonial-style2">
                                    ...
                                    <div class="bottom">
                                        <div class="rating-box">
                                            ...
                                            for ($x = 1; $x <= 5; $x++) {
												if($x <= $ratting) echo '<li><span class="fa fa-star"></span></li>'; else echo '<li><span class="fa fa-star-half"></span></li>'; 
												}
											?>
                                            </ul>
                                        </div>
