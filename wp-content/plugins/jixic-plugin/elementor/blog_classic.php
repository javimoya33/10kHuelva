 ...
 * @since 1.0.0
 */
class Blog_Classic extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog Classic', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'blog_classic',
			[
				'label' => esc_html__( 'Blog Classic', 'jixic' ),
			]
		);
		$this->add_control(
			'query_number',
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="post-pagination text-center">
                            <?php jixic_the_pagination2(array('total'=>$query->max_num_pages, 'next_text' => '<i class="fa fa-angle-right"></i> ', 'prev_text' => '<i class="fa fa-angle-left"></i>')); ?>
                        </div>
                    </div>
                </div>
            </div>
