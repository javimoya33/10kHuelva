 ...
 * @since 1.0.0
 */
class Special_Features extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Special Features', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'special_features',
			[
				'label' => esc_html__( 'Special Features', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="features-area">
            <div class="auto-container">
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="feature-carousel-outer-box">
                            <div class="feature-carousel owl-carousel owl-theme style1">
                                ...
                                <div class="single-feature-box text-center">
                                    ...
                                    <div class="inner">
                                        <div class="icon"><?php the_post_thumbnail('jixic_183x150'); ?></div>
                                        <div class="text">
                                            <h3><?php the_title(); ?></h3>
