 ...
 * @since 1.0.0
 */
class Classic_Portfolio_V3 extends Widget_Base {
	...
	public function get_name() {
		return 'jixic_classic_portfolio_v3';
	}
	...
	public function get_title() {
		return esc_html__( 'Classic Portfolio V3', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Classic Portfolio V3', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <!--Start Portfolio Style5 Area-->
        <section class="portfolio-style5-area">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="portfolio-style5-title clearfix">
                            <div class="title float-left"><?php echo wp_kses( $settings['title'], $allowed_tags); ?></div>
                        </div>    
                    </div>
                </div>
                <div class="row masonary-layout">
					...
					?>
                    <!--Start Single Portfolio Style5-->
                    <div class="<?php if(get_post_meta( get_the_id(), 'dimension', true) == 'extra_width_height') echo 'col-xl-8 col-lg-8'; elseif(get_post_meta( get_the_id(), 'dimension', true) == 'extra_width') echo 'col-xl-8 col-lg-8'; else echo 'col-xl-4 col-lg-4'?>">
                        <div class="single-portfolio-style5">
                    ...
                    <!--End Single Portfolio Style5-->
                    <?php endwhile; ?>
                </div>
            </div>    
        </section>
        <!--End Portfolio Style5 Area-->
