...
class Options {
	 ...
	 * @var string
	 */
	private $opt_name = JIXIC_NAME . '_options';
	...
	private $page_slug = JIXIC_NAME . '_options';
	...
	function init() {
		...
		$this->menu_title = esc_html__( 'JIXIC Options', 'jixic' );
		$this->page_title = esc_html__( 'JIXIC Options', 'jixic' );
	...
	function helpTabs() {
		...
		$tabs = array(
			array(
				'id'      => 'redux-help-tab-1',
				'title'   => esc_html__( 'Theme Information 1', 'jixic' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'jixic' ),
			),
			array(
				'id'      => 'redux-help-tab-2',
				'title'   => esc_html__( 'Theme Information 2', 'jixic' ),
				'content' => esc_html__( '<p>This is the tab content, HTML is allowed.</p>', 'jixic' ),
			),
		);
		...
		$content = '<p>' . esc_html__( 'This is the sidebar content, HTML is allowed.', 'jixic' ) . '</p>';
	...
	function sections() {
		...
		$sections_path = apply_filters( 'jixic_redux_sections', $sections_path );
		...
		foreach ( $sections_path as $key => $file ) {
			...
			if ( file_exists( $file ) ) {
				...
				$options = apply_filters( "jixic_redux_sections_{$key}", $options );
