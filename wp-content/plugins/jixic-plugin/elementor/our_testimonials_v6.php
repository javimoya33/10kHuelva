 ...
 * @since 1.0.0
 */
class Our_Testimonials_V6 extends Widget_Base {
	...
	public function get_name() {
		return 'jixic_our_testimonials_v6';
	}
	...
	public function get_title() {
		return esc_html__( 'Our Testimonials V6', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_testimonials_v6',
			[
				'label' => esc_html__( 'Our Testimonials V6', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="testimonial-style3-area about-page">
            <div class="container">
