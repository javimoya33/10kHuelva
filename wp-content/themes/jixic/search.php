...
get_header();
global $wp_query;
$data  = \JIXIC\Includes\Classes\Common::instance()->data( 'search' )->get();
                    ...
                    <div class="blog-post">
                        ...
                        <?php else : ?>
							<div class="search-notfound">
								<h4>
									<?php printf(esc_html__( 'No result found for "%s"', 'jixic' ), get_search_query()); ?>
								</h4>
								<p><?php esc_html_e( 'Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'jixic' ); ?></p>
