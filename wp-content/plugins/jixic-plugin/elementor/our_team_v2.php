...
class Our_Team_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Team V2', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_team_v2',
			[
				'label' => esc_html__( 'Our Team V2', 'jixic' ),
			]
		);
		$this->add_control(
			'subtitle',
			[
				...
				'default'     => __( 'Meet Team Members', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
			[
				...
				'default'     => __( 'Team behind our success', 'jixic' ),
			]
		);
		$this->add_control(
			'query_number',
                ...
                <div class="row">
                    <div class="col-xl-12">
                        <div class="team-carousel owl-carousel owl-theme">
                            ...
                            <!--Start single team member Style2-->
