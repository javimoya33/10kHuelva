...
<div class="boxed_wrapper">
    ...
    <!-- Main header -->
    <header class="main-header style5 style5withstyle6 about-page">
        ...
        <div class="header-upper-style5">
            <div class="outer-container clearfix">
                ...
                <div class="header-upper-left clearfix">
                    <div class="logo">
                        <?php echo jixic_logo( $logo_type, $image_logo7, $logo_dimension7, $logo_text, $logo_typography ); ?>
                    </div>
                </div>
                ...
                <div class="header-upper-right clearfix">
                    <div class="header-right-content">
                        <?php if( $options->get( 'show_shoping_cart_icon_7' ) ):?>
                        ...
                        <?php if( $options->get( 'show_search_form_7' ) ):?>
