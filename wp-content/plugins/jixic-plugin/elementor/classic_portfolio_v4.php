 ...
 * @since 1.0.0
 */
class Classic_Portfolio_V4 extends Widget_Base {
	...
	public function get_name() {
		return 'jixic_classic_portfolio_v4';
	}
	...
	public function get_title() {
		return esc_html__( 'Classic Portfolio V4', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Classic Portfolio V4', 'jixic' ),
			]
		);
		$this->add_control(
			'number',
	...
	protected function render() {
		...
		<?php 
            ...
            <div class="col-xl-4 col-lg-4 filter-item <?php echo esc_attr($term_slug); ?>">
                <div class="single-portfolio-style6">
                    <div class="img-holder">
                        <?php the_post_thumbnail('jixic_600x400'); ?>
            ...
            <!--Start Portfolio Style6 Area-->
            <section class="portfolio-style6-area">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
