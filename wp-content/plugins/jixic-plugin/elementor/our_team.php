...
class Our_Team extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Team', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_team',
			[
				'label' => esc_html__( 'Our Team', 'jixic' ),
			]
		);
		$this->add_control(
			'subtitle',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'People behind our success', 'jixic' ),
			]
		);
		$this->add_control(
			'query_number',
