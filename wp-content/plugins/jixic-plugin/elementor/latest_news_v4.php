...
class Latest_News_V4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Latest News V4', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'latest_news_v4',
			[
				'label' => esc_html__( 'latest News V4', 'jixic' ),
			]
		);
		$this->add_control(
			'subtitle',
	...
	protected function render() {
        ...
        <!--Start Latest Blog Style4 Area Css-->
        <section class="latest-blog-style4-area">
            <div class="container">
                <div class="sec-title-style5 center text-center">
                    ...
                    <div class="col-xl-12">
                        <div class="blog-style4-carousel owl-carousel owl-theme">
                            ...
                            <div class="single-blog-post-style4">
                                <div class="top-box">
                                    <div class="image-bg" style="background-image:url(<?php echo esc_url($post_thumbnail_url); ?>);"></div>
                                    <div class="static">
                                        <div class="post-info"><p><?php $post_date = get_the_date( 'l' ); echo $post_date; ?>, <?php the_category(' '); ?></p></div>
                                        <h3><a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php the_title(); ?></a></h3>
                                    </div>
                                    <div class="overlay">
                                        <div class="meta-box">
                                            <ul>
                                                <?php if(function_exists('jixic_like_us')) echo wp_kses(jixic_like_us(get_the_id()), $allowed_tags);?>
                                                <li><a href="<?php echo esc_url(get_permalink(get_the_id()).'#comments'); ?>"><span class="icon-comment"></span><?php comments_number( wp_kses(__('0' , 'jixic'), true), wp_kses(__('1' , 'jixic'), true), wp_kses(__('%' , 'jixic'), true)); ?></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="bottom-box">
                                    ...
                                    <div class="overlay">
                                        <a href="<?php echo esc_url( the_permalink( get_the_id() ) );?>"><?php esc_html_e('Continue Reading', 'jixic'); ?><i class="fa fa-angle-right" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
        ...
        <!--End Latest Blog Style4 Area Css-->
