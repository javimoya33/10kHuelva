...
class Our_Projects extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Projects', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_projects',
			[
				'label' => esc_html__( 'Our Projects', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="latest-project-style2-area">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="project-style2-carousel-outer-box">
                            <div class="sec-title-style3">
                                <div class="title"><?php echo wp_kses( $settings['title'], true );?></div>
                                <div class="borders"><span></span></div>
                            </div>
                            <div class="project-style2-carousel owl-carousel owl-theme style1">
                                <?php
                                ...
                                <div class="single-project-style2">
                                    <div class="img-holder">
                                        <?php the_post_thumbnail('jixic_775x550'); ?>
                                        <div class="overlay-content">
                                            <div class="categories">
                                                <h5><?php echo implode( ', ', (array)$term_list );?></h5>
                                            </div>
                                            <div class="title">
                                                <h1><a href="<?php echo (get_post_meta( get_the_id(), 'project_link', true ));?>"><?php the_title(); ?></a></h1>
                                            </div>
                                        </div>
                                    </div>    
                                </div>
