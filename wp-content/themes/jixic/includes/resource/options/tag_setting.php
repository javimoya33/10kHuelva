...
return array(
	'title'      => esc_html__( 'Tag Page Settings', 'jixic' ),
	'id'         => 'tag_setting',
	'desc'       => '',
	'subsection' => true,
	'fields'     => array(
		array(
			'id'      => 'tag_source_type',
			'type'    => 'button_set',
			'title'   => esc_html__( 'Tag Source Type', 'jixic' ),
			'options' => array(
		...
		array(
			'id'       => 'tag_default_st',
			'type'     => 'section',
			'title'    => esc_html__( 'Tag Default', 'jixic' ),
			'indent'   => true,
		...
		array(
			...
			'default'  => array(
				'url' => JIXIC_URI . 'assets/images/resources/breadcrumb-bg.jpg',
			),
			'required' => array( 'tag_page_banner', '=', true ),
		),
