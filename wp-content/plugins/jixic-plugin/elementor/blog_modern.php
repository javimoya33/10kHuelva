 ...
 * @since 1.0.0
 */
class Blog_Modern extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Blog Modern', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'blog_modern',
			[
				'label' => esc_html__( 'Blog Modern', 'jixic' ),
			]
		);
		$this->add_control(
			'query_number',
	...
	protected function render() {
        ...
        <!--Start Blog Modern Area-->
        <section id="blog-modern-area">
            <div class="outer-container">
                <div class="row masonary-layout">
                    <?php while ( $query->have_posts() ) : $query->the_post(); ?>
                    <!--Start Single Blog Post Style6-->
                    <div class="<?php if(get_post_meta( get_the_id(), 'dimension', true) == 'extra_width') echo 'col-xl-6 col-lg-6'; elseif(get_post_meta( get_the_id(), 'dimension', true) == 'extra_height') echo 'col-xl-3 col-lg-6'; else echo 'col-xl-3 col-lg-6'?>">
                        <div class="single-blog-post-style6">
                            <div class="img-holder">
                                <?php 
									$dimention = get_post_meta( get_the_id(), 'dimension', true );
									if($dimention == 'extra_width'){
										$image_size = 'jixic_900x390';
									}
									elseif($dimention == 'extra_height'){
										$image_size = 'jixic_450x780';
									}
									else{
										$image_size = 'jixic_450x390'; 
									}
