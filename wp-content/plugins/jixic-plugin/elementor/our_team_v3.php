...
class Our_Team_V3 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Team V3', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_team_v3',
			[
				'label' => esc_html__( 'Our Team V3', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
			[
				...
				'default'     => __( 'Creative & dedicated team', 'jixic' ),
			]
		);
		$this->add_control(
			'query_number',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'Meet All Members', 'jixic' ),
			]
		);
		$this->add_control(
			'btn_link',
	...
	protected function render() {
        ...
        <section class="team-style3-area">
            <div class="container">
                <div class="top-title text-center"><h1><?php echo wp_kses( $settings['title'], true );?></h1></div>
                <div class="row">
                    <?php while ( $query->have_posts() ) : $query->the_post(); 
						$team_hover_img = get_post_meta( get_the_id(), 'team_hover_image', true );
					?>
                    <!--Start Single Team Member Style3-->
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-team-member-style3 text-center">
                            <div class="img-holder">
                                <?php the_post_thumbnail('jixic_370x370'); ?>
                                <div class="overlay-content" style="background-image:url(<?php echo esc_url($team_hover_img['url']);?>);">
                                    <?php
                    ...
                    <!--End Single Team Member Style3-->
                    <?php endwhile; ?>
                </div>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="meet-all-member-button text-center">
