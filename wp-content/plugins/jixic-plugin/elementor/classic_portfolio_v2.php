 ...
 * @since 1.0.0
 */
class Classic_Portfolio_V2 extends Widget_Base {
	...
	public function get_name() {
		return 'jixic_classic_portfolio_v2';
	}
	...
	public function get_title() {
		return esc_html__( 'Classic Portfolio V2', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Classic Portfolio V2', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <!--Start Portfolio Style4 Area-->
        <section class="portfolio-style4-area">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="portfolio-style4-title clearfix">
                ...
                <div class="row">
					...
					?>
                    <!--Start Single Portfolio Style4-->
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-portfolio-style4">
                            <div class="img-holder">
                                <div class="image-inner">
                                    <?php the_post_thumbnail('jixic_310x310'); ?>
                                </div>
                                <div class="overlay-content">
                                    <div class="inner">
                                        <div class="box"> 
                                            <a href="<?php echo (get_post_meta( get_the_id(), 'project_link', true ));?>"><span class="icon-link"></span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <!--End Single Portfolio Style4-->
                    <?php endwhile; ?>
                </div>
            </div>    
        </section>
        <!--End Portfolio Style4 Area-->
