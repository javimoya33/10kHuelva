...
class Our_Team_V4 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Our Team V4', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'our_team_v4',
			[
				'label' => esc_html__( 'Our Team V4', 'jixic' ),
			]
		);
		$this->add_control(
			'query_number',
	...
	protected function render() {
        ...
        <!--Start Team Style4 Area-->
        <section class="team-style4-area">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="team-carousel-style2 owl-carousel owl-theme">
