...
class Related_Project extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Related Project', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'related_project',
			[
				'label' => esc_html__( 'Related Project', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="related-project-area">
            <div class="container">
                <div class="title"><h3><?php echo wp_kses( $settings['title'], $allowed_tags); ?></h3></div>
                <div class="row">
                    <?php
						global $post;
