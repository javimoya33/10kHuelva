...
<div class="boxed_wrapper">
    ...
    <!-- Main header -->
    <header class="main-header style5">
        ...
        <div class="header-upper-style5">
            <div class="outer-container clearfix">
                ...
                <div class="header-upper-left clearfix">
                    <div class="logo">
                        <?php echo jixic_logo( $logo_type, $image_logo5, $logo_dimension5, $logo_text, $logo_typography ); ?>
                    </div>
                </div>
                ...
                <div class="header-upper-right clearfix">
                    <div class="header-right-content">
                        <?php if( $options->get( 'show_shoping_cart_icon_5' ) ):?>
                        <?php if( function_exists( 'WC' ) ): global $woocommerce; ?>
                        <div class="cart-box">
                            <a href="<?php echo esc_url( wc_get_cart_url() ); ?>"><span class="icon-cart"><span class="number"><?php echo wp_kses( $woocommerce->cart->cart_contents_count, true ); ?></span></span></a>
                        </div>
                        <?php endif; endif; ?>
                            
                        <?php if( $options->get( 'show_search_form_5' ) ):?>
