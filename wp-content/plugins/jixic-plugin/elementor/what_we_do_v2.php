 ...
 * @since 1.0.0
 */
class What_We_Do_V2 extends Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'What We Do V2', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			'what_we_do_v2',
			[
				'label' => esc_html__( 'What We Do V2', 'jixic' ),
			]
		);
		$this->add_control(
            'bg_img',
		...
		$this->add_control(
			...
			[
				...
				'default'     => __( 'What We do for you', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="services-style2-area">
            <div class="services-style2-area-bg" style="background-image:url(<?php echo esc_url( $settings['bg_img']['url'] );?>);">
                <div class="book float_up_down_two"></div>
            </div>
            <div class="container">
                <div class="sec-title-style3 text-center">
                    <h6 class="clr-white"><?php echo wp_kses( $settings['subtitle'], true );?></h6>
                        ...
                        <div class="inner-content">
                            <div class="services-carousel owl-carousel owl-theme">
                                ...
                                <div class="single-service-style2" data-aos="fade-up" data-aos-easing="linear" data-aos-duration="700">
                                    ...
                                    <div class="icon-holder"><span class="<?php echo get_post_meta( get_the_id(), 'service_icon', true )?>"></span></div> 
                                    <div class="text"><p><?php echo jixic_trim(get_the_content(), $settings['text_limit']); ?></p></div>
                                    <div class="read-more">
                                        <a href="<?php echo esc_url(get_post_meta( get_the_id(), 'ext_url', true ));?>"><?php esc_html_e('Read More', 'jixic'); ?></a>
                                    </div>   
                                </div>
