 ...
 * @since 1.0.0
 */
class Classic_Portfolio_V1 extends Widget_Base {
	...
	public function get_name() {
		return 'jixic_classic_portfolio_v1';
	}
	...
	public function get_title() {
		return esc_html__( 'Classic Portfolio V1', 'jixic' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Classic Portfolio V1', 'jixic' ),
			]
		);
		$this->add_control(
			'title',
	...
	protected function render() {
        ...
        <section class="portfolio-style3-area">
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                        <div class="portfolio-style3-title clearfix">
                ...
                <div class="row">
					...
					?>
                    <!--Start Single Portfolio Style3-->
                    <div class="col-xl-4 col-lg-4">
                        <div class="single-portfolio-style3">
                            <div class="img-holder">
                                <?php the_post_thumbnail('jixic_370x250'); ?>
                                <div class="overlay-content">
                                    <div class="inner">
                                        <div class="box"> 
                                            <div class="link" style="background-image:url(<?php echo esc_url($overlay_img['url']);?>);">
