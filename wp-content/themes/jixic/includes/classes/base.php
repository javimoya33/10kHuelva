...
use JIXIC\Includes\Classes\Header_Enqueue;
use JIXIC\Includes\Classes\Options;
...
class Base {
	...
	public static function instance() {
		...
		if ( isset( $GLOBALS['jixic_base'] ) ) {
			return $GLOBALS['jixic_base'];
		}
	...
	function option( $key = '' ) {
		...
		$options = (array) get_theme_mod( JIXIC_NAME . '_options-mods' );

		$dn = jixic_dot( $options );
